...
ctypedef void (*fast_sentence_sg_hs_ptr) (
    ...
    REAL_t *syn0, REAL_t *syn0_topic, REAL_t *syn1, const int size,
        ...
        for i in range(sentence_len):
            ...
            for j in range(j, k):
                if j == i or codelens[j] == 0:
                    continue
                if hs:
                    fast_sentence_sg_hs(points[i], codes[i], codelens[i], syn0, syn0_topic, syn1,size1, word_index[j], topic_index[j], _alpha, work)
            #if negative:
